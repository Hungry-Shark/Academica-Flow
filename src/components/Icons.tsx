...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  name: 'logo' | 'menu' | 'close' | 'dashboard' | 'profile' | 'download' | 'image' | 'spinner' | 'google' | 'back' | 'sliders' | 'calendar' | 'users' | 'tools' | 'mail' | 'github' | 'twitter' | 'linkedin' | 'edit' | 'save' | 'refresh' | 'clock' | 'info' | 'home' | 'user' | 'logout' | 'check';
}
